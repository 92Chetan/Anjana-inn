...
const page = () => {
  return (
    <Container className="py-6">
      <h1 className="text-3xl pb-6">Privacy Policy</h1>
      <p className="pb-3">Last updated: May 20, 2024</p>
      <p className="py-3">
      ...
      <h2 className="text-2xl py-3">Interpretation and Definitions</h2>
      <h3 className="text-xl py-3">Interpretation</h3>
      <p>
        The words of which the initial letter is capitalized have meanings defined under the
        following conditions. The following definitions shall have the same meaning regardless of
        whether they appear in singular or in plural.
      </p>
      <h3 className="py-3 text-xl">Definitions</h3>
      ...
      <ul className="py-3">
        ...
        <li>
          <p className="py-3">
            ...
            <a href="http://Anjanainn.com" rel="external nofollow noopener" target="_blank">
              http://Anjanainn.com
            </a>
          </p>
        </li>
      ...
      <h2 className="py-3 text-2xl">Collecting and Using Your Personal Data</h2>
      <h3 className="py-3 text-xl">Types of Data Collected</h3>
      ...
      <h4 className="text-lg py-3">Usage Data</h4>
      ...
      <ul className="pt-3 flex flex-col justify-center gap-3">
        <li>
          <p>
      ...
      <h3 className="text-xl pb-3">Use of Your Personal Data</h3>
      <p>The Company may use Personal Data for the following purposes:</p>
      <ul className="py-3 flex flex-col justify-center gap-3">
        <li>
          <p>
      ...
      <h3 className="text-xl pb-3">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="py-3 font-xl">Disclosure of Your Personal Data</h3>
      ...
      <h3 className="text-xl py-3">Security of Your Personal Data</h3>
      <p>
      ...
      <h2 className="py-3 text-2xl">Children's Privacy</h2>
      <p>
      ...
      <h2 className="py-3 text-2xl">Links to Other Websites</h2>
      <p>
      ...
      <h2 className=" text-2xl pb-3">Changes to this Privacy Policy</h2>
      <p>
      ...
      <h2 className="py-3 text-2xl">Contact Us</h2>
      <p>If you have any questions about this Privacy Policy, You can contact us:</p>
      <ul className="flex justify-center  flex-col pt-3">
        <li>
          <p>By email: Info.anjanainn@gmail.com</p>
        </li>
      </ul>
    </Container>
  );
