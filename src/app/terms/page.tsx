...
const page = () => {
  return (
    <Container className="py-3 flex justify-center flex-col gap-3">
      <h1 className="text-3xl py-3">Terms and Conditions</h1>
      ...
      <ul className="flex justify-center flex-col gap-3">
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Anjana inn.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Anjana inn, accessible from{' '}
            <a href="Anjanainn.com" rel="external nofollow noopener" target="_blank">
              Anjanainn.com
            </a>
          </p>
        </li>
      ...
      <ul>
        <li>By email: info.anjanainn@gmail.com</li>
      </ul>
    </Container>
  );
};
