    ...
    <React.Fragment>
      {!disableNavWithFooter.includes(path) && (
        <div className=" flex justify-center items-center">
          <div
            className="fixed md:bottom-12 md:right-5 right-2 z-10 gap-1 group bottom-4 cursor-pointer flex justify-center items-center"
            onClick={() =>
              window.open('https://wa.me/6260849824?text=Any one there i want help', '_blank')
            }
          >
            <p className="bg-black text-white dark:bg-white dark:text-black rounded-lg px-2">
              Need help?
            </p>
            <div className="">
              <svg
                ...
                x="0px"
                y="0px"
                className="md:w-14 md:h-14 w-[40px] h-[40px]"
                viewBox="0 0 48 48"
              >
                <path
                  fill="#fff"
